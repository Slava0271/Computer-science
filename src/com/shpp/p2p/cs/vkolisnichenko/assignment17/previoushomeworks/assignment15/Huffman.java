...
public class Huffman {
     ...
     * @return sorted list
     */
    public ListLinked<TreesNode> treesNodes(HashMap<Byte, Integer> map) {
        ListLinked<TreesNode> nodes = new ListLinked<>();
     ...
     */
    public HashMap<Byte, String> coding(ListLinked<TreesNode> linkedList, TreesNode node) {
     ...
     */
    public TreesNode huffmanAlgorithm(ListLinked<TreesNode> nodes) {
        while (nodes.size() > 1) {
            //sorted list
