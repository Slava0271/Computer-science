package com.shpp.p2p.cs.vkolisnichenko.assignment17.previoushomeworks.assignment13;

import com.shpp.p2p.cs.vkolisnichenko.assignment17.previoushomeworks.collecctions.queue.MyQueue;
...
public class Assignment13Part1 implements Constans {
    ...
    private static MyQueue<int[]> queue = new MyQueue<>();
    ...
    private static void breadthFirstSearch(int[][] rgbValues) {
        ...
        while (!queue.empty()) {
            ...
            if (isTopPixel(coordinates, rgbValues)) {
                ...
                coordinates[0] -= 1;
                //add to queue
                queue.push(Arrays.copyOf(coordinates, coordinates.length));
                rgbValues[coordinates[0]][coordinates[1]] = MARK_BACKGROUND;
                coordinates[0] += 1;
            }
