...
public class UnArchive {
    ...
    public void unArchive() throws Exception {
        ...
        ArrayList<StringBuilder> builders = readFile(inputStream);
        ...
        //get decoded bytes
        ArrayList<Byte> bytes = decode(read, tableMap);
     ...
     */
    private ArrayList<Byte> decode(StringBuilder stringBuilder, HashMap<Byte, String> codes) {
     ...
     */
    private ArrayList<Byte> bytes(ArrayList<String> encoded, ArrayList<String> mapKey,
     ...
     * @throws Exception - can throw exception
     */
    private ArrayList<StringBuilder> readFile(DataInputStream inputStream) throws Exception {
