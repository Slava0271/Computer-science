...
public class Archive {
    ...
    public void archive() throws Exception {
        ...
        LinkedList<TreesNode> linkedList = huffman.treesNodes(sortBytes.numberOfRepetitions(bytes));
        LinkedList<TreesNode> list = huffman.treesNodes(sortBytes.numberOfRepetitions(bytes));
